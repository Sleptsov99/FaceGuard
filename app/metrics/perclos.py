...
class ClosureEvent:
    ...
    def is_long(self) -> bool:
        return self.duration_ms >= 500.0   # class-level default exposed via property
...
class PerclosTracker:
    ...
    def __init__(
        ...
        # Frame buffer: (timestamp_ms, is_closed)
    ...
    def update(
        ...
        # ── timeout guard (face disappeared mid-closure) ──────────────────────
