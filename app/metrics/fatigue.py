...
# PERCLOS thresholds from the literature:
#   < 0.08  → alert
#   0.08–0.15 → mild drowsiness
#   > 0.15  → significant drowsiness
#   > 0.30  → severe drowsiness / microsleeps
PERCLOS_SATURATION = 0.30   # PERCLOS at which component reaches 1.0

# "Normal" blink duration for an alert person (Caffier et al., 2003)
NORMAL_BLINK_DURATION_MS = 150.0

# Number of long closures per minute that saturates that component
